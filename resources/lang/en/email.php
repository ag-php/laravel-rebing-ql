...
return [
    ...
    'hiUser' => 'Hi, :userName,',
    'activation' => [
        'welcome' => ':userName, welcome to Miaum.',
    ...
    'forgotPassword' => [
        'requestPassword' => 'We have received a request to reset your password. '.
    ...
    'ZipFile' => [
        ...
        'zipReady' => 'The zip file was requested on :createdDate and it is '.
          'ready to be downloaded. You can <a href=":href" style=":style">download</a> '.
          'the files using your Miaum account',
    ],
];
