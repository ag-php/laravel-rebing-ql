...
return [
    'translation_blocked' =>
        "Sorry, the translation :translation_id couldn't " .
        "be deleted or updated because it's blocked",
    'translation_blocked_texts' =>
        "Sorry, the translation :translation_id couldn't " .
        "be updated because it's blocked. " .
        "You only may update the empty translations.",
    'translation_blocked_code' =>
        "Sorry, the code's translation :translation_id couldn't " .
        "be updated because it's blocked.",
    ...
    'translation_blocked_deleted' =>
        "The blocked translation :translation_id " .
